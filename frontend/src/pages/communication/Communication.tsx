...
import { Send, Mail, Bell, Users, CheckCircle, AlertCircle } from 'lucide-react';
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-500">Send announcements via Email and In-App Notifications</p>
      </div>
